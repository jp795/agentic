...
class QuasiAgent(APIKeyInitializer):
    ...
    def writeFile(self):
        print("Preparing to write the file")
        fileName = "M0107QuasiAgent_UserFunction.py"
        with open(fileName, 'w') as f:
            f.write(self.responses[1].llm_response + '\n\n' + self.responses[2].llm_response)
        print(f"Python code and test cases have been save to {f.name}")
